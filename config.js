module.exports = {
	...
	token: process.env.token || "MTA4MDE1NDYxMzM2MzI1MzI2MA.GgTzBp.II1tIN0g_6LB7RmpswzJ_rjHYQg0HpIPex_FmQ", //- Bot's Token
	clientId: process.env.clientId || "1080154613363253260", //- ID of the bot
	clientSecret: process.env.clientSecret || "ahd6QPR43eqa3y39-APaSM6VFs2CDR5f", //- Client Secret of the bot
	...
	nodes: [
		{
			...
			host: "lava4.horizxon.studio", //- The host name or IP of the lavalink server.
